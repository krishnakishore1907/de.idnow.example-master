...
public class RestControllerExample4 extends MainController{
        ...
        running(testServer(3333, fakeApplication(inMemoryDatabase())), new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    assertEquals("checking if its equal to 1 :: ",first.getId(),1);
                    assertEquals("checking if its equal to 2 :: ",second.getId(),2);
